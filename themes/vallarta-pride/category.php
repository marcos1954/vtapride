...
get_header();
  ...
  if ( in_category( 'Noticias' ) || in_category('News')){ 
    ...
    ?> <img src="<?php echo $page_headimg['0']; ?>" width="100%" alt="<?php the_title_attribute(); ?>"><?php
  }else{  
        ...
        <div class="w-col w-col-9">
          ...
          <?php }else{ ?>
            ...
            <div class="gallery-item">
              <?php $gallery_thumb = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'gallery-sponsors-thumbs' ); ?>
