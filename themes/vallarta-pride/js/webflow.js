...
//alert( 'Alert for disconnected Webflow forms'); // mpage
    // Alert for disconnected Webflow forms
    disconnected();
//alert( 'after Alert for disconnected Webflow forms'); // mpage
  }
...
Webflow.require('ix').init([
  {"slug":"fadein","name":"fadein","value":{"style":{"opacity":0},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"close","name":"close","value":{"style":{},"triggers":[{"type":"click","selector":".pop-up-wrapper","stepsA":[{"display":"none"}],"stepsB":[]}]}}
]);
