        ...
        <div class="w-col w-col-3 sidebar">
          ...
          <h3 class="sidebar-heading">
            ...
            <?php 
              ...
              $lang = $language = get_bloginfo('language');
          ...
          <?php
            //echo 'hello from sidebar.php <br />';
            //echo 'skipping related template <br />';
            get_template_part('includes/related');
            //echo 'hello again from sidebar.php after related <br />';
          ?>
          ...
          <div class="w-hidden-small w-hidden-tiny sidebar-banner">
             ...
             <?php if( function_exists( 'wpx_bannerize' ) ) {
                if($lang=='en-US'){ ////////////mpage
                wpx_bannerize( array( 'random' => true, 'category' => 'sidebar', 'numbers'  => 1, 'orderby'  => 'menu_order') );
                }else{
                wpx_bannerize( array( 'random' => true, 'category' => 'barra-lateral', 'numbers'  => 1, 'orderby'  => 'menu_order') );
                }
              } ?>
